...
// config screen
export const UPDATE_NETWORK_TARGET = 'UPDATE_NETWORK_TARGET';
...
export const SET_SELECTED_NETWORK_UUID = 'SET_SELECTED_NETWORK_UUID';
...
export const SET_ADDED_NETWORK_UUID = 'SET_ADDED_NETWORK_UUID';
